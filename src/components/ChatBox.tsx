      ...
      setMessages([
        {
          ...
          content: "Hi there! I'm your InsuraBot assistant. I can help explain insurance policies, coverage details, and insurance terminology. What would you like to know about insurance today?",
          role: "assistant",
          timestamp: new Date(),
        },
      ]);
        ...
        <Card className="flex flex-col w-80 sm:w-96 h-[500px] shadow-premium rounded-lg border overflow-hidden">
          ...
          <div className="bg-insura-blue text-white p-3 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <Bot size={20} />
              <h3 className="font-medium">Policy Explainer Bot</h3>
            </div>
            <Button
              variant="ghost"
              size="icon"
            ...
            {isLoading && (
              <div className="bg-white text-gray-800 border rounded-lg p-3 max-w-[85%] mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm">Policy Explainer is thinking...</p>
                </div>
              </div>
            )}
          ...
          <div className="p-3 border-t bg-white">
            <div className="flex gap-2">
              <Input
                ...
                placeholder="Ask about insurance terms, coverage..."
                className="flex-1"
                disabled={isLoading}
              />
              <Button
            ...
            <div className="flex items-center gap-1 mt-2 text-xs text-muted-foreground">
              <HelpCircle size={12} />
              <span>Try asking: "What is a deductible?" or "How do claims work?"</span>
            </div>
          </div>
        </Card>
      ) : (
